...
my $s = 'нӓдэ́бэ́л /тым./ 1. прич. от гл. нӓдэ́бэ́гу; 2. отгл. прил. - женатый: ~ қуп «женатый человек»; см. калдап';
...
grammar article {
	rule TOP {
		<title_wrap> <meaning_wrap> <see_group>* .*# <meaning_group> <see_group>
	}
	token title_wrap {
	...
	token example_group {
		[ <original> <geo_marking>* \h* "«" <translation> "»" <comment_wrap>* ] + % [ [ \;\s+ ] ? ]
	}
	token comment_wrap {
		\s+ \( <comment> \)
	}
